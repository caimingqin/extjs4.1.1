Ext.define('view.B1', {
	...
	initComponent : function() {
		...
		var fileUrlGrid = Ext.create('Ext.grid.Panel', {
					height : 70,
					width : 500,
					scroll : true,
					tbar:[{xtype:'mebutton',text:'delete'}],
					columns : [{
								text : '보험종목',
								flex : 1,
								dataIndex : 'name'
		...
		var bb = Ext.widget('fieldset', {
					...
					items : [levelAndfeeAndrequestLevelCode,
							...
							accidentContents, jsContents, fileUrlGrid,
							uploadForm]
				})
		...
		var grid = Ext.create('Ext.grid.Panel', {
			...
			tbar : [date1, date2, manageType, customerCdn, requestStatusCdn,
					likeCnd, likeComboCnd, initBtn, createtBtn],
			store : store,
			columns : [{
						text : '보고서 번호 ',
						flex : 1,
