Ext.define('view.B4', {
	...
	initComponent : function() {
		 ...
		 * 260, tbar : [date1, date2, manageType, customerCdn, requestStatusCdn,
		 * searchBtn], store : store, columns : [{ text : '보고서번호 ', flex : 1,
		 * dataIndex : 'documentNumber' }, { text : '보험사 ', flex : 1, dataIndex :
		 * 'customer', renderer : Common.cusRender }, { text : '접수일자 ', flex :
		 * 1, dataIndex : 'acceptDate', renderer : Common.yyyy_MM_dd }, { text :
		 * '보험계약자 ', flex : 1, dataIndex : 'accident', renderer :
		 * Common.defaultRender }, { text : '분류 ', flex : 1, dataIndex :
		 * 'managementType', renderer : Common.defaultRender }] })
		 */
